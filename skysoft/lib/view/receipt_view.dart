...
import 'package:skysoft/view/import_from_prrevious_receipt_view.dart';
                                      ...
                                      builder: (controller) => GestureDetector(
                                          onTap: controller.enabled
                                              ? () async {
                                                      ...
                                                      await Get.dialog(
                                                          ImportFromPreviousReceiptsView()).then((value)async {
                                                            if(value==null){
                                                             return;
                                                            }
                                                      ...
                                                      controller.updateFreeItemCount();
